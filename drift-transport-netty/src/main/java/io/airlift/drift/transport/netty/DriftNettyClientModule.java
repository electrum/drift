        ...
        implements Module
{
    ...
    public void configure(Binder binder)
    {
        ...
        configBinder(binder).bindConfigurationBindingListener(DriftNettyClientModule::bindDriftNettyClientConfig);
    }

    private static void bindDriftNettyClientConfig(ConfigurationBinding<?> binding, ConfigBinder configBinder)
    {
