...
public class TestThriftMethodMetadata
{
    ...
    {
        ThriftMethodMetadata metadata = new ThriftMethodMetadata("test", getMethod(methodName), new ThriftCatalog());
    ...
    {
        return new ThriftMethodMetadata("test", getMethod(methodName, boolean.class), THRIFT_CATALOG);
    }
