...
final class DriftNettyTesterUtil
{
            ...
            boolean secure)
    {
        ...
        try (DriftNettyMethodInvokerFactory<String> methodInvokerFactory = new DriftNettyMethodInvokerFactory<>(
            ...
            DriftScribe scribe = proxyFactory.createDriftClient(DriftScribe.class, filters).get();
            ...
            boolean secure)
    {
        ...
        try (DriftNettyMethodInvokerFactory<String> methodInvokerFactory = new DriftNettyMethodInvokerFactory<>(
            ...
            DriftAsyncScribe scribe = proxyFactory.createDriftClient(DriftAsyncScribe.class, filters).get();
